    ...
    <div className="bg-white font-sans">
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Add-ons Section - Redesigned to match example */}
            ...
            <div className="flex flex-col md:flex-row">
              <div className="md:w-1/2 p-8 flex flex-col justify-center">
                ...
                <ul className="space-y-2 mb-6">
                  {addons[0].features.map((feature, i) => (
                ...
                <a href="#" className="md:hidden inline-block text-center bg-indigo-600 text-white py-2 px-4 rounded font-medium hover:bg-indigo-700 transition-colors">
                  Add to Your Plan
                </a>
              </div>
              <div className="md:w-1/2 bg-indigo-50 p-8 flex flex-col justify-center items-center text-center">
                ...
                <div className="flex items-center justify-center mt-2">
                  <span className="text-4xl font-bold text-indigo-900">
                    {isYearly ? addons[0].yearlyPrice : addons[0].monthlyPrice}
                  </span>
                ...
                <a href="#" className="hidden md:inline-block text-center bg-indigo-600 text-white py-2 px-6 rounded font-medium hover:bg-indigo-700 transition-colors w-full max-w-xs">
                  Add to Your Plan
                </a>
              </div>
            </div>
